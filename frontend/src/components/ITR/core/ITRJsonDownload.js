...
const ITRJsonDownload = ({
  ...
  return (
    ...
    >
      ...
      <Card className="p-6">
        <div className="text-center">
          ...
          {isDownloading && downloadProgress > 0 && (
            <div className="mb-4">
              <div className="flex justify-between text-body-regular text-slate-600 mb-2">
      ...
      <Card className="p-6">
        <h4 className="text-heading-4 font-semibold text-slate-900 mb-4">Alternative Formats</h4>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="text-center p-4 border border-slate-200 rounded-xl">
            ...
            <h5 className="font-medium text-slate-900 mb-2">Government Format</h5>
          ...
          <div className="text-center p-4 border border-slate-200 rounded-xl">
            ...
            <h5 className="font-medium text-slate-900 mb-2">Backup Format</h5>
            <p className="text-body-regular text-slate-600 mb-3">
      ...
      <Card className="p-6 bg-blue-50 border-blue-200">
        <h4 className="text-heading-4 font-semibold text-blue-900 mb-4">📋 How to File Your ITR Using JSON</h4>
        <div className="space-y-3">
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-body-regular font-medium">1</span>
          ...
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-body-regular font-medium">3</span>
            <p className="text-body-regular text-blue-800">
              Login with your PAN and go to e-File → Income Tax Return → File Income Tax Return
            </p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-body-regular font-medium">4</span>
            <p className="text-body-regular text-blue-800">
              Select Assessment Year, choose the ITR type, and select "Upload JSON" option
            </p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-body-regular font-medium">5</span>
            <p className="text-body-regular text-blue-800">
              Upload the downloaded JSON file, verify the data, and submit your return
            </p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-body-regular font-medium">6</span>
            <p className="text-body-regular text-blue-800">
        ...
        <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
          <div className="flex items-start space-x-3">
            ...
            <div className="text-body-regular text-yellow-800">
      ...
      {itrData && (
        <Card className="p-6">
          <h4 className="text-heading-4 font-semibold text-slate-900 mb-4">📊 Data Validation Summary</h4>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-body-regular text-slate-600">ITR Type:</span>
                <span className="text-body-regular font-medium">{itrType}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-body-regular text-slate-600">Assessment Year:</span>
                <span className="text-body-regular font-medium">{assessmentYear}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-body-regular text-slate-600">Sections Completed:</span>
                <span className="text-body-regular font-medium">{Object.keys(itrData).length}</span>
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-body-regular text-slate-600">Personal Info:</span>
                <span className={`text-sm font-medium ${itrData.personal ? 'text-green-600' : 'text-error-600'}`}>
                  {itrData.personal ? '✅ Complete' : '⚠️ Incomplete'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-body-regular text-slate-600">Income Details:</span>
                <span className={`text-sm font-medium ${itrData.income ? 'text-green-600' : 'text-error-600'}`}>
                  {itrData.income ? '✅ Complete' : '⚠️ Incomplete'}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-body-regular text-slate-600">Verification:</span>
                <span className={`text-sm font-medium ${itrData.verification ? 'text-green-600' : 'text-error-600'}`}>
