/**
 * Static Login Page Component
 * This component is completely static to prevent any re-renders
 */
...
// Static Login component - no hooks, no state
const Login = React.memo(() => {
  const navigate = useNavigate();
  const location = useLocation();

  const handleLoginSuccess = React.useCallback((response) => {
